...
public:
	...
	NRC(std::shared_ptr<Model::ModelInterface> robot,
		...
		KEY_EE_POS          (kRedisKeyPrefix + "tasks::ee_pos"),
		KEY_EE_POS_DES      (kRedisKeyPrefix + "tasks::ee_pos_des"),
		...
		KEY_KP_POSITION     (kRedisKeyPrefix + "tasks::kp_pos"),
		KEY_KV_POSITION     (kRedisKeyPrefix + "tasks::kv_pos"),
		KEY_KP_ORIENTATION  (kRedisKeyPrefix + "tasks::kp_ori"),
		KEY_KV_ORIENTATION  (kRedisKeyPrefix + "tasks::kv_ori"),
		KEY_KP_JOINT        (kRedisKeyPrefix + "tasks::kp_joint"),
		KEY_KV_JOINT        (kRedisKeyPrefix + "tasks::kv_joint"),
